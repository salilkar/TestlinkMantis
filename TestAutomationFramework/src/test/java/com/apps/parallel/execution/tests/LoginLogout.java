...
import com.apps.pages.BoxHomePage;
import com.apps.pages.BoxLoginPage;
import com.apps.pages.BoxSplashScreenPage;
import com.apps.prerequisitesParallel.BaseClass;

public class LoginLogout extends BaseClass {

	RemoteWebDriver driver;
	BoxSplashScreenPage splashPage;
	BoxLoginPage loginPage;
	BoxHomePage homePage;
	...
	public void loginTest(String username, String password) throws Exception {
		...
		try {
			...
			splashPage = new BoxSplashScreenPage(driver);
			loginPage = new BoxLoginPage(driver);
			homePage = new BoxHomePage(driver);
